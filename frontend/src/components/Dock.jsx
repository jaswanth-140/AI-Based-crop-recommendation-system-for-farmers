  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto flex w-full max-w-5xl gap-2 px-4 justify-between items-center"
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={`absolute -top-8 left-1/2 w-fit whitespace-pre rounded-md border border-gray-200 bg-white px-2 py-1 text-xs text-gray-700 shadow-md ${className}`}
          role="tooltip"
          style={{ x: '-50%' }}
        >
          {children}
